...
f4gemm_bf16_mxfp4_ABpreShuffle_64x256_1x4_batch_ps:
	...
	s_prefetch_inst s[24:25], 0x3000, s26, 0                   ; 000000001944: F404800C 34007C00
	s_prefetch_inst s[24:25], 0x4000, s26, 0                   ; 00000000194C: F404800C 34008C00
	s_prefetch_inst s[24:25], 0x5000, s26, 0                   ; 000000001954: F404800C 34009C00
...
.Lbranch_000000001f08:
	...
	s_mov_b32 s100, 1
	s_mov_b32 s101, 0
	s_mov_b32 s72, 0x00200000
	s_or_b32 s72, s72, 0xf
	s_lshl_b32 s24, s15, 5
	s_lshl_b32 s25, s24, 16
	s_or_b32 s73, s73, s25
	s_lshr_b32 s25, s24, 16
	s_or_b32 s74, s74, s25
	s_mul_i32 s25, s55, 0x40
	s_sub_co_u32 s25, s17, s25
	s_lshr_b32 s25, s25, 5
	s_lshl_b32 s26, s25, 16
	s_or_b32 s74, s74, s26
	s_lshr_b32 s26, s25, 16
	s_or_b32 s75, s75, s26
	s_or_b32 s75, s75, 0x1000000
	s_or_b32 s76, s76, 1
	s_lshl_b32 s25, s15, 5
	s_mov_b32 s77, s25
	s_mul_i32 s25, s55, 0x40
	s_mul_hi_u32 s103, s25, s15
	s_mul_i32 s25, s25, s15
	s_add_co_u32 s102, s8, s25
	s_add_co_ci_u32 s103, s103, s9
	s_and_b32 s103, s103, 0x1ffffff
	s_or_b32 s103, s103, 0x80000000
	s_mov_b32 s46, 0x8000
	s_mov_b32 s47, 0x8200
	s_mov_b32 s93, 0x8400
	s_mov_b32 s99, 0x8600
	...
	s_mov_b32 s101, s46
	tensor_load_to_lds s[100:103], s[72:79]
	s_add_co_u32 s102, s102, 0x100
	s_add_co_ci_u32 s103, s103, 0
...
.Lbranch_000000002b48:
	...
	s_and_b32 s103, s103, 0x1ffffff
	s_or_b32 s103, s103, 0x80000000
	s_mov_b32 s46, 0x8100
	s_mov_b32 s47, 0x8300
	s_mov_b32 s93, 0x8500
	s_mov_b32 s99, 0x8700
...
.Lbranch_0000000037ac:
	...
	s_or_b32 s39, s39, 0x8000000                               ; 00000000387C: 8C27FF27 01000000
	...
	s_or_b32 s67, s26, 0x8000000                               ; 000000003950: 8C43FF1A 01000000
	; === wave2 scale: ScaleB_half1 ===
	s_mov_b32 s73, 0
	s_mov_b32 s74, 0
	s_mov_b32 s75, 0
	s_mov_b32 s76, 0
	...
	s_mov_b32 s72, 0x00200000
	s_mov_b32 s24, 1
	s_lshl_b32 s24, s24, s49
	s_or_b32 s72, s72, s24
	s_lshl_b32 s24, s16, 5
	s_lshl_b32 s25, s24, 16
	s_or_b32 s73, s73, s25
	s_lshr_b32 s25, s24, 16
	s_or_b32 s74, s74, s25
	s_mul_i32 s25, s54, 0x100
	s_sub_co_u32 s25, s18, s25
	s_lshr_b32 s25, s25, 5
	s_lshl_b32 s26, s25, 16
	s_or_b32 s74, s74, s26
	s_lshr_b32 s26, s25, 16
	...
	s_or_b32 s75, s75, 0x1000000
	s_or_b32 s76, s76, 4
	s_lshl_b32 s25, s16, 5
	s_mov_b32 s77, s25
	s_mul_i32 s25, s54, 0x100
	s_mul_hi_u32 s103, s25, s16
	s_mul_i32 s25, s25, s16
	s_add_co_u32 s102, s10, s25
	s_add_co_ci_u32 s103, s103, s11
	s_and_b32 s103, s103, 0x1ffffff
	s_or_b32 s103, s103, 0x80000000
	s_mov_b32 s46, 0x8800
	s_mov_b32 s47, 0x9000
	s_mov_b32 s93, 0x9800
	s_mov_b32 s99, 0xa000
...
.Lbranch_0000000043f8:
	...
	s_or_b32 s39, s39, 0x8000000                               ; 0000000044C8: 8C27FF27 01000000
	...
	s_or_b32 s67, s26, 0x8000000                               ; 0000000045B8: 8C43FF1A 01000000
	; === wave3 scale: ScaleB_half2 ===
	s_mov_b32 s73, 0
	s_mov_b32 s74, 0
	s_mov_b32 s75, 0
	s_mov_b32 s76, 0
	...
	s_and_b32 s103, s103, 0x1ffffff
	s_or_b32 s103, s103, 0x80000000
	s_mov_b32 s46, 0x8c00
	s_mov_b32 s47, 0x9400
	s_mov_b32 s93, 0x9c00
	s_mov_b32 s99, 0xa400
...
.Lbranch_000000007158:
	...
	v_wmma_scale_f32_32x16x128_f4 v[32:47], v[192:207], v[24:31], v[32:47], v92, v82 matrix_b_scale:MATRIX_SCALE_ROW1 matrix_b_reuse
	v_wmma_scale_f32_32x16x128_f4 v[0:15], v[208:223], v[16:23], v[0:15], v93, v83
	v_wmma_scale_f32_32x16x128_f4 v[32:47], v[208:223], v[32:39], v[32:47], v93, v83 matrix_b_scale:MATRIX_SCALE_ROW1 matrix_b_reuse
	v_wmma_scale_f32_32x16x128_f4 v[64:79], v[192:207], v[40:47], v[64:79], v92, v84
	v_wmma_scale_f32_32x16x128_f4 v[96:111], v[192:207], v[56:63], v[96:111], v92, v84 matrix_b_scale:MATRIX_SCALE_ROW1 matrix_b_reuse
	v_wmma_scale_f32_32x16x128_f4 v[64:79], v[208:223], v[48:55], v[64:79], v93, v85
	v_wmma_scale_f32_32x16x128_f4 v[96:111], v[208:223], v[64:71], v[96:111], v93, v85 matrix_b_scale:MATRIX_SCALE_ROW1 matrix_b_reuse
	s_set_vgpr_msb 0
	s_wait_alu depctr_va_vdst(0)
	s_wait_dscnt 0
	s_set_vgpr_msb 0x50
	v_wmma_scale_f32_32x16x128_f4 v[16:31], v[224:239], v[8:15], v[16:31], v94, v82
	v_wmma_scale_f32_32x16x128_f4 v[48:63], v[224:239], v[24:31], v[48:63], v94, v82 matrix_b_scale:MATRIX_SCALE_ROW1 matrix_b_reuse
	v_wmma_scale_f32_32x16x128_f4 v[16:31], v[240:255], v[16:23], v[16:31], v95, v83
	v_wmma_scale_f32_32x16x128_f4 v[48:63], v[240:255], v[32:39], v[48:63], v95, v83 matrix_b_scale:MATRIX_SCALE_ROW1 matrix_b_reuse
	v_wmma_scale_f32_32x16x128_f4 v[80:95], v[224:239], v[40:47], v[80:95], v94, v84
	v_wmma_scale_f32_32x16x128_f4 v[112:127], v[224:239], v[56:63], v[112:127], v94, v84 matrix_b_scale:MATRIX_SCALE_ROW1 matrix_b_reuse
	v_wmma_scale_f32_32x16x128_f4 v[80:95], v[240:255], v[48:55], v[80:95], v95, v85
	v_wmma_scale_f32_32x16x128_f4 v[112:127], v[240:255], v[64:71], v[112:127], v95, v85 matrix_b_scale:MATRIX_SCALE_ROW1 matrix_b_reuse
	s_set_vgpr_msb 0
	s_wait_alu depctr_va_vdst(0)
	s_wait_dscnt 0
	s_wait_dscnt 0
...
.Lbranch_00000000ad68:
	...
	v_cvt_pk_bf16_f32 v130, v4, v5
	v_cvt_pk_bf16_f32 v131, v6, v7
	v_cvt_pk_bf16_f32 v132, v8, v9
	v_cvt_pk_bf16_f32 v133, v10, v11
	v_cvt_pk_bf16_f32 v134, v12, v13
	v_cvt_pk_bf16_f32 v135, v14, v15
	v_cvt_pk_bf16_f32 v136, v16, v17
	v_cvt_pk_bf16_f32 v137, v18, v19
	v_cvt_pk_bf16_f32 v138, v20, v21
	v_cvt_pk_bf16_f32 v139, v22, v23
	v_cvt_pk_bf16_f32 v140, v24, v25
	v_cvt_pk_bf16_f32 v141, v26, v27
	v_cvt_pk_bf16_f32 v142, v28, v29
	v_cvt_pk_bf16_f32 v143, v30, v31
	v_cvt_pk_bf16_f32 v144, v32, v33
	v_cvt_pk_bf16_f32 v145, v34, v35
	v_cvt_pk_bf16_f32 v146, v36, v37
	v_cvt_pk_bf16_f32 v147, v38, v39
	v_cvt_pk_bf16_f32 v148, v40, v41
	v_cvt_pk_bf16_f32 v149, v42, v43
	v_cvt_pk_bf16_f32 v150, v44, v45
	v_cvt_pk_bf16_f32 v151, v46, v47
	v_cvt_pk_bf16_f32 v152, v48, v49
	v_cvt_pk_bf16_f32 v153, v50, v51
	v_cvt_pk_bf16_f32 v154, v52, v53
	v_cvt_pk_bf16_f32 v155, v54, v55
	v_cvt_pk_bf16_f32 v156, v56, v57
	v_cvt_pk_bf16_f32 v157, v58, v59
	v_cvt_pk_bf16_f32 v158, v60, v61
	v_cvt_pk_bf16_f32 v159, v62, v63
	v_cvt_pk_bf16_f32 v160, v64, v65
	v_cvt_pk_bf16_f32 v161, v66, v67
	v_cvt_pk_bf16_f32 v162, v68, v69
	v_cvt_pk_bf16_f32 v163, v70, v71
	v_cvt_pk_bf16_f32 v164, v72, v73
	v_cvt_pk_bf16_f32 v165, v74, v75
	v_cvt_pk_bf16_f32 v166, v76, v77
	v_cvt_pk_bf16_f32 v167, v78, v79
	v_cvt_pk_bf16_f32 v168, v80, v81
	v_cvt_pk_bf16_f32 v169, v82, v83
	v_cvt_pk_bf16_f32 v170, v84, v85
	v_cvt_pk_bf16_f32 v171, v86, v87
	v_cvt_pk_bf16_f32 v172, v88, v89
	v_cvt_pk_bf16_f32 v173, v90, v91
	v_cvt_pk_bf16_f32 v174, v92, v93
	v_cvt_pk_bf16_f32 v175, v94, v95
	v_cvt_pk_bf16_f32 v176, v96, v97
	v_cvt_pk_bf16_f32 v177, v98, v99
	v_cvt_pk_bf16_f32 v178, v100, v101
	v_cvt_pk_bf16_f32 v179, v102, v103
	v_cvt_pk_bf16_f32 v180, v104, v105
	v_cvt_pk_bf16_f32 v181, v106, v107
	v_cvt_pk_bf16_f32 v182, v108, v109
	v_cvt_pk_bf16_f32 v183, v110, v111
	v_cvt_pk_bf16_f32 v184, v112, v113
	v_cvt_pk_bf16_f32 v185, v114, v115
	v_cvt_pk_bf16_f32 v186, v116, v117
	v_cvt_pk_bf16_f32 v187, v118, v119
	v_cvt_pk_bf16_f32 v188, v120, v121
	v_cvt_pk_bf16_f32 v189, v122, v123
	v_cvt_pk_bf16_f32 v190, v124, v125
