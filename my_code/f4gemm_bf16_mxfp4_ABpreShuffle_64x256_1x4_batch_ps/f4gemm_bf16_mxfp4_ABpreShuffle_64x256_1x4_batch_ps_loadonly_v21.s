	...
	; ---------------------------------------------------------------------
	.set __aiter_moe_v21_contract, 1
	.protected	f4gemm_bf16_mxfp4_ABpreShuffle_64x256_moe_loadonly_v21
	.globl	f4gemm_bf16_mxfp4_ABpreShuffle_64x256_moe_loadonly_v21
	.p2align	8
	.type	f4gemm_bf16_mxfp4_ABpreShuffle_64x256_moe_loadonly_v21,@function
...
.Lbranch_000000001da0:
	...
	; ScaleA tile base in production wmma_rep-preshuffled layout.
	s_mov_b32 s80, s8
	s_mov_b32 s81, s9
...
.Lbranch_000000001f08:
	...
	s_mov_b32 s26, 2                                           ; A lower split: two valid M16 blocks
	...
	s_mov_b32 s53, 0                                         ; A multicast: all four N WGs in the M row
	...
	s_mov_b32 s27, 2                                           ; next A lower split: two valid M16 blocks
	...
	s_mov_b32 m0, s90
	cluster_load_b128 v[82:85], v8, s[80:81]
	s_mov_b32 m0, s91
	cluster_load_b128 v[92:95], v8, s[82:83]
	...
	s_mov_b32 m0, s90
	cluster_load_b128 v[86:89], v8, s[80:81]
	s_mov_b32 m0, s91
	cluster_load_b128 v[96:99], v8, s[82:83]
	...
	s_mov_b32 m0, s90
	cluster_load_b128 v[100:103], v8, s[80:81]
	s_mov_b32 m0, s91
	cluster_load_b128 v[108:111], v8, s[82:83]
	...
	s_mov_b32 m0, s90
	cluster_load_b128 v[104:107], v8, s[80:81]
	s_mov_b32 m0, s91
	cluster_load_b128 v[112:115], v8, s[82:83]
...
.Lbranch_000000002b48:
	...
	s_mov_b32 s26, 0                                           ; A upper split: both M16 blocks are OOB
	...
	s_mov_b32 s27, 0                                           ; next A upper split: both M16 blocks are OOB
...
.Lbranch_0000000037ac:
	...
	s_mov_b32 s53, 0                                           ; SA multicast: all four N WGs in the M row
...
.Lbranch_000000005060:
	...
	s_mov_b32 s27, 2                                           ; next full A: only lower two M16 blocks are valid
	...
	s_mov_b32 s26, 2                                           ; full A: only lower two M16 blocks are valid
...
.Lbranch_00000000ba60:
	...
	.p2align	6, 0x0
	.amdhsa_kernel f4gemm_bf16_mxfp4_ABpreShuffle_64x256_moe_loadonly_v21
	...
	.text
.Lfunc_end0:
	.size	f4gemm_bf16_mxfp4_ABpreShuffle_64x256_moe_loadonly_v21, .Lfunc_end0-f4gemm_bf16_mxfp4_ABpreShuffle_64x256_moe_loadonly_v21

	.set f4gemm_bf16_mxfp4_ABpreShuffle_64x256_moe_loadonly_v21.num_vgpr, 384
	.set f4gemm_bf16_mxfp4_ABpreShuffle_64x256_moe_loadonly_v21.num_agpr, 0
	.set f4gemm_bf16_mxfp4_ABpreShuffle_64x256_moe_loadonly_v21.numbered_sgpr, 104
	.set f4gemm_bf16_mxfp4_ABpreShuffle_64x256_moe_loadonly_v21.num_named_barrier, 0
	.set f4gemm_bf16_mxfp4_ABpreShuffle_64x256_moe_loadonly_v21.private_seg_size, 0
	.set f4gemm_bf16_mxfp4_ABpreShuffle_64x256_moe_loadonly_v21.uses_vcc, 1
	.set f4gemm_bf16_mxfp4_ABpreShuffle_64x256_moe_loadonly_v21.uses_flat_scratch, 0
	.set f4gemm_bf16_mxfp4_ABpreShuffle_64x256_moe_loadonly_v21.has_dyn_sized_stack, 0
	.set f4gemm_bf16_mxfp4_ABpreShuffle_64x256_moe_loadonly_v21.has_recursion, 0
	.set f4gemm_bf16_mxfp4_ABpreShuffle_64x256_moe_loadonly_v21.has_indirect_call, 0
...
amdhsa.kernels:
  - .args:
    ...
    .name:           f4gemm_bf16_mxfp4_ABpreShuffle_64x256_moe_loadonly_v21
    ...
    .reqd_workgroup_size:
      ...
      - 1
    .sgpr_count:     106
    .symbol:         f4gemm_bf16_mxfp4_ABpreShuffle_64x256_moe_loadonly_v21.kd
