...
.Lbranch_000000001f08:
	...
	s_mov_b32 s88, 0x20000
	s_mov_b32 s89, 0x28000
	s_mov_b32 s90, 0x30000
	s_mov_b32 s91, 0x38000
	s_mov_b32 s100, 1
	s_mov_b32 s101, 0
	s_mov_b32 s102, 0
	s_mov_b32 s103, 0x80000000
	s_mov_b32 s101, 0x20000
	s_mov_b32 s102, s74
...
.Lbranch_000000002b48:
	...
	s_mov_b32 s96, 0xa000
	s_mov_b32 s97, 0xc000
	s_mov_b32 s98, 0xe000
	s_mov_b32 s32, 1
	s_mov_b32 s33, 0
	s_mov_b32 s34, 0
	s_mov_b32 s35, 0x80000000
	...
	s_mov_b32 s88, 0x22000
	s_mov_b32 s89, 0x2a000
	s_mov_b32 s90, 0x32000
	s_mov_b32 s91, 0x3a000
	s_mov_b32 s100, 1
	s_mov_b32 s101, 0
	s_mov_b32 s102, 0
	s_mov_b32 s103, 0x80000000
	s_mov_b32 s101, 0x22000
	s_mov_b32 s102, s74
	s_and_b32 s75, s75, 0x1ffffff
	s_and_b32 s103, s103, 0xfe000000
	s_or_b32 s103, s75, s103
	; wave1: shift the current-task base by 1*64 N rows
	s_mov_b32 s24, 0x40
	...
	s_barrier_signal -1
	s_barrier_wait 0xffff
	s_mov_b32 s33, 0xe000
	s_mov_b32 s101, 0x3a000
	tensor_load_to_lds s[32:35], s[36:43] th:TH_LOAD_NT
	tensor_load_to_lds s[100:103], s[80:87]
	s_add_co_u32 s24, s58, 0x400
	s_cmp_lt_u32 s24, s70
...
.Lbranch_0000000037ac:
	s_mov_b32 s95, 0x10000
	s_mov_b32 s96, 0x12000
	s_mov_b32 s97, 0x14000
	s_mov_b32 s98, 0x16000
	s_mov_b32 s32, 1
	s_mov_b32 s33, 0
	s_mov_b32 s34, 0
	s_mov_b32 s35, 0x80000000
	...
	s_mov_b32 s88, 0x24000
	s_mov_b32 s89, 0x2c000
	s_mov_b32 s90, 0x34000
	s_mov_b32 s91, 0x3c000
	s_mov_b32 s100, 1
	s_mov_b32 s101, 0
	s_mov_b32 s102, 0
	s_mov_b32 s103, 0x80000000
	s_mov_b32 s101, 0x24000
	s_mov_b32 s102, s74
	s_and_b32 s75, s75, 0x1ffffff
	s_and_b32 s103, s103, 0xfe000000
	s_or_b32 s103, s75, s103
	; wave2: shift the current-task base by 2*64 N rows
	s_mov_b32 s24, 0x80
	s_mul_hi_u32 s25, s24, s14
	s_mul_i32 s24, s24, s14
	s_add_co_u32 s102, s102, s24
	...
	s_barrier_signal -1
	s_barrier_wait 0xffff
	s_mov_b32 s33, 0x12000
	s_mov_b32 s101, 0x2c000
	tensor_load_to_lds s[32:35], s[36:43] th:TH_LOAD_NT
	tensor_load_to_lds s[100:103], s[80:87]
	s_add_co_u32 s24, s58, 0x200
	s_cmp_lt_u32 s24, s70
	...
	s_barrier_signal -1
	s_barrier_wait 0xffff
	s_mov_b32 s33, 0x14000
	s_mov_b32 s101, 0x34000
	tensor_load_to_lds s[32:35], s[36:43] th:TH_LOAD_NT
	tensor_load_to_lds s[100:103], s[80:87]
	s_add_co_u32 s24, s58, 0x300
	s_cmp_lt_u32 s24, s70
	...
	s_barrier_signal -1
	s_barrier_wait 0xffff
	s_mov_b32 s33, 0x16000
	s_mov_b32 s101, 0x3c000
	tensor_load_to_lds s[32:35], s[36:43] th:TH_LOAD_NT
	tensor_load_to_lds s[100:103], s[80:87]
	s_add_co_u32 s24, s58, 0x400
	s_cmp_lt_u32 s24, s70
...
.Lbranch_0000000043f8:
	s_mov_b32 s95, 0x18000
	s_mov_b32 s96, 0x1a000
	s_mov_b32 s97, 0x1c000
	s_mov_b32 s98, 0x1e000
	s_mov_b32 s32, 1
	s_mov_b32 s33, 0
	s_mov_b32 s34, 0
	s_mov_b32 s35, 0x80000000
	...
	s_mov_b32 s88, 0x26000
	s_mov_b32 s89, 0x2e000
	s_mov_b32 s90, 0x36000
	s_mov_b32 s91, 0x3e000
	s_mov_b32 s100, 1
	s_mov_b32 s101, 0
	s_mov_b32 s102, 0
	s_mov_b32 s103, 0x80000000
	s_mov_b32 s101, 0x26000
	s_mov_b32 s102, s74
	s_and_b32 s75, s75, 0x1ffffff
	s_and_b32 s103, s103, 0xfe000000
	s_or_b32 s103, s75, s103
	; wave3: shift the current-task base by 3*64 N rows
	s_mov_b32 s24, 0xc0
	s_mul_hi_u32 s25, s24, s14
	s_mul_i32 s24, s24, s14
	s_add_co_u32 s102, s102, s24
	...
	s_barrier_signal -1
	s_barrier_wait 0xffff
	s_mov_b32 s33, 0x1a000
	s_mov_b32 s101, 0x2e000
	tensor_load_to_lds s[32:35], s[36:43] th:TH_LOAD_NT
	tensor_load_to_lds s[100:103], s[80:87]
	s_add_co_u32 s24, s58, 0x200
	s_cmp_lt_u32 s24, s70
	...
	s_barrier_signal -1
	s_barrier_wait 0xffff
	s_mov_b32 s33, 0x1c000
	s_mov_b32 s101, 0x36000
	tensor_load_to_lds s[32:35], s[36:43] th:TH_LOAD_NT
	tensor_load_to_lds s[100:103], s[80:87]
	s_add_co_u32 s24, s58, 0x300
	s_cmp_lt_u32 s24, s70
	...
	s_barrier_signal -1
	s_barrier_wait 0xffff
	s_mov_b32 s33, 0x1e000
	s_mov_b32 s101, 0x3e000
	tensor_load_to_lds s[32:35], s[36:43] th:TH_LOAD_NT
	tensor_load_to_lds s[100:103], s[80:87]
	s_add_co_u32 s24, s58, 0x400
	s_cmp_lt_u32 s24, s70
