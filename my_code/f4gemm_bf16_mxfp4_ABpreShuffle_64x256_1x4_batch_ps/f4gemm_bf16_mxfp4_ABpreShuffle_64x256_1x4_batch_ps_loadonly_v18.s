...
.Lbranch_00000000195c:
	...
	v_lshlrev_b32_e32 v8, 2, v0                                ; v8 = lane_id * 4 (scale byte offset)
...
.Lbranch_000000001da0:
	...
	; Scale base addresses for global_load_b32
	s_mov_b32 s80, s8
	s_mov_b32 s81, s9
	s_mov_b32 s82, s10
	s_mov_b32 s83, s11
...
.Lbranch_000000001f08:
	...
	s_or_b32 s40, s40, 2                                      ; preshuffle blocks: 4 * (16 rows * 0x80 bytes)
	...
	global_load_b32 v82, v8, s[80:81]
	global_load_b32 v83, v8, s[80:81] offset:128
	global_load_b32 v84, v8, s[80:81] offset:256
	global_load_b32 v85, v8, s[80:81] offset:384
	global_load_b32 v92, v8, s[82:83]
	global_load_b32 v93, v8, s[82:83] offset:128
	global_load_b32 v94, v8, s[82:83] offset:256
	global_load_b32 v95, v8, s[82:83] offset:384
	...
	s_cselect_b64 s[80:81], s[80:81], s[84:85]
	s_cselect_b64 s[82:83], s[82:83], s[86:87]
	...
	s_cselect_b64 s[26:27], s[88:89], 0
	...
	global_load_b32 v86, v8, s[80:81]
	global_load_b32 v87, v8, s[80:81] offset:128
	global_load_b32 v88, v8, s[80:81] offset:256
	global_load_b32 v89, v8, s[80:81] offset:384
	global_load_b32 v96, v8, s[82:83]
	global_load_b32 v97, v8, s[82:83] offset:128
	global_load_b32 v98, v8, s[82:83] offset:256
	global_load_b32 v99, v8, s[82:83] offset:384
	...
	global_load_b32 v100, v8, s[80:81]
	global_load_b32 v101, v8, s[80:81] offset:128
	global_load_b32 v102, v8, s[80:81] offset:256
	global_load_b32 v103, v8, s[80:81] offset:384
	global_load_b32 v108, v8, s[82:83]
	global_load_b32 v109, v8, s[82:83] offset:128
	global_load_b32 v110, v8, s[82:83] offset:256
	global_load_b32 v111, v8, s[82:83] offset:384
	...
	global_load_b32 v104, v8, s[80:81]
	global_load_b32 v105, v8, s[80:81] offset:128
	global_load_b32 v106, v8, s[80:81] offset:256
	global_load_b32 v107, v8, s[80:81] offset:384
	global_load_b32 v112, v8, s[82:83]
	global_load_b32 v113, v8, s[82:83] offset:128
	global_load_b32 v114, v8, s[82:83] offset:256
	global_load_b32 v115, v8, s[82:83] offset:384
...
.Lbranch_000000002b48:
	...
	s_or_b32 s40, s40, 2                                      ; preshuffle blocks: 16 * (16 rows * 0x80 bytes)
...
.Lbranch_000000007158:
	...
	global_load_b32 v82, v8, s[80:81]                         ; SA scale k0
	global_load_b32 v83, v8, s[80:81] offset:128              ; SA scale k1
	global_load_b32 v84, v8, s[80:81] offset:256              ; SA scale k2
	global_load_b32 v85, v8, s[80:81] offset:384              ; SA scale k3
	global_load_b32 v92, v8, s[82:83]                         ; SB scale k0
	global_load_b32 v93, v8, s[82:83] offset:128              ; SB scale k1
	global_load_b32 v94, v8, s[82:83] offset:256              ; SB scale k2
	global_load_b32 v95, v8, s[82:83] offset:384              ; SB scale k3
...
.Lbranch_000000007890:
	...
	s_barrier_wait 0xffff
	tensor_load_to_lds s[32:35], s[36:43] th:TH_LOAD_NT
	global_load_b32 v86, v8, s[80:81]                         ; SA scale k0
	global_load_b32 v87, v8, s[80:81] offset:128              ; SA scale k1
	global_load_b32 v88, v8, s[80:81] offset:256              ; SA scale k2
	global_load_b32 v89, v8, s[80:81] offset:384              ; SA scale k3
	global_load_b32 v96, v8, s[82:83]                         ; SB scale k0
	global_load_b32 v97, v8, s[82:83] offset:128              ; SB scale k1
	global_load_b32 v98, v8, s[82:83] offset:256              ; SB scale k2
	global_load_b32 v99, v8, s[82:83] offset:384              ; SB scale k3
	s_add_co_u32 s24, s58, 0x500
	s_cmp_lt_u32 s24, s70
	s_cselect_b64 s[34:35], s[34:35], s[62:63]
	s_cselect_b32 s36, s36, s64
...
.Lbranch_000000007fc8:
	...
	s_barrier_wait 0xffff
	tensor_load_to_lds s[32:35], s[36:43] th:TH_LOAD_NT
	global_load_b32 v100, v8, s[80:81]                         ; SA scale k0
	global_load_b32 v101, v8, s[80:81] offset:128              ; SA scale k1
	global_load_b32 v102, v8, s[80:81] offset:256              ; SA scale k2
	global_load_b32 v103, v8, s[80:81] offset:384              ; SA scale k3
	global_load_b32 v108, v8, s[82:83]                         ; SB scale k0
	global_load_b32 v109, v8, s[82:83] offset:128              ; SB scale k1
	global_load_b32 v110, v8, s[82:83] offset:256              ; SB scale k2
	global_load_b32 v111, v8, s[82:83] offset:384              ; SB scale k3
	s_add_co_u32 s24, s58, 0x500
	s_cmp_lt_u32 s24, s70
	s_cselect_b64 s[34:35], s[34:35], s[62:63]
	s_cselect_b32 s36, s36, s64
...
.Lbranch_000000008700:
	...
	s_barrier_wait 0xffff
	tensor_load_to_lds s[32:35], s[36:43] th:TH_LOAD_NT
	global_load_b32 v104, v8, s[80:81]                         ; SA scale k0
	global_load_b32 v105, v8, s[80:81] offset:128              ; SA scale k1
	global_load_b32 v106, v8, s[80:81] offset:256              ; SA scale k2
	global_load_b32 v107, v8, s[80:81] offset:384              ; SA scale k3
	global_load_b32 v112, v8, s[82:83]                         ; SB scale k0
	global_load_b32 v113, v8, s[82:83] offset:128              ; SB scale k1
	global_load_b32 v114, v8, s[82:83] offset:256              ; SB scale k2
	global_load_b32 v115, v8, s[82:83] offset:384              ; SB scale k3
	s_cmp_eq_u32 s22, 0
