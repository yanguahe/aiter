...
.Lbranch_000000001f08:
	...
	s_mov_b32 s33, 0
	s_mov_b32 s34, 0
	s_mov_b32 s35, 0x80000000
	s_mov_b32 s33, 0
	s_mov_b32 s34, s72
	s_and_b32 s73, s73, 0x1ffffff
	s_and_b32 s35, s35, 0xfe000000
	...
	s_and_b32 s38, s38, 0xffff0000
	s_lshl_b32 s24, s26, 16
	s_or_b32 s37, s24, s37
	s_lshr_b32 s24, s26, 16
	s_or_b32 s38, s24, s38
	s_mul_i32 s24, s55, 0x40
	s_sub_co_u32 s26, s17, s24
	s_lshr_b32 s26, s26, 4
	s_and_b32 s38, s38, 0xffff
	s_and_b32 s39, s39, 0xffff0000
	s_lshl_b32 s24, s26, 16
	s_or_b32 s38, s24, s38
	s_lshr_b32 s24, s26, 16
	...
	s_and_b32 s40, s40, 0xffff0000
	s_or_b32 s40, s40, 1
	s_lshl_b32 s24, s13, 4
	s_mov_b32 s25, 0
	s_mov_b32 s41, s24
	s_and_b32 s25, s25, 0xffff
	s_and_b32 s42, s42, 0xffff0000
	s_or_b32 s42, s42, s25
	s_bitset0_b32 s36, 20
	s_mov_b32 s53, 0xf
	s_and_b32 s36, s36, 0xffff0000
	s_or_b32 s36, s53, s36
	s_bitset1_b32 s36, 21
	s_mov_b32 s56, 0x800
	s_mov_b32 s57, 0
	s_mul_i32 s24, s69, 0x40
	s_mul_hi_u32 s63, s24, s13
	s_mul_i32 s24, s24, s13
	s_add_co_u32 s62, s4, s24
	s_add_co_ci_u32 s63, s63, s5
	s_and_b32 s63, s63, 0x1ffffff
	s_or_b32 s63, s63, 0x80000000
	s_mov_b32 s64, s36
	s_mov_b32 s65, s37
	...
	s_and_b32 s66, s38, 0xffff
	s_or_b32 s66, s66, s26
	s_lshr_b32 s26, s27, 16
	s_or_b32 s67, s26, 0x8000000
	; --- wave0 B quarter: N[0:63] ---
	s_mov_b32 s88, 0xa800
	s_mov_b32 s89, 0x12800
	s_mov_b32 s90, 0x1a800
	s_mov_b32 s91, 0x22800
	s_mov_b32 s100, 1
	s_mov_b32 s101, 0
	s_mov_b32 s102, 0
	s_mov_b32 s103, 0x80000000
	s_mov_b32 s101, 0xa800
	s_mov_b32 s102, s74
	s_and_b32 s75, s75, 0x1ffffff
	s_and_b32 s103, s103, 0xfe000000
	s_or_b32 s103, s75, s103
	s_mov_b32 s80, 0
	s_mov_b32 s81, 0
	s_mov_b32 s82, 0
	s_mov_b32 s83, 0
	...
	s_and_b32 s82, s82, 0xffff0000
	s_lshl_b32 s24, s26, 16
	s_or_b32 s81, s24, s81
	s_lshr_b32 s24, s26, 16
	s_or_b32 s82, s24, s82
	s_mul_i32 s24, s54, 0x100
	s_sub_co_u32 s26, s18, s24
	s_lshr_b32 s26, s26, 4
	s_and_b32 s82, s82, 0xffff
	s_and_b32 s83, s83, 0xffff0000
	s_lshl_b32 s24, s26, 16
	s_or_b32 s82, s24, s82
	s_lshr_b32 s24, s26, 16
	s_or_b32 s83, s24, s83
	s_and_b32 s83, s83, 0xffff
	s_or_b32 s83, s83, 0x8000000
	s_and_b32 s84, s84, 0xffff0000
	s_or_b32 s84, s84, 4
	s_lshl_b32 s24, s14, 4
	s_mov_b32 s25, 0
	s_mov_b32 s85, s24
	s_and_b32 s25, s25, 0xffff
	s_and_b32 s86, s86, 0xffff0000
	s_or_b32 s86, s86, s25
	s_bitset0_b32 s80, 20
	s_mov_b32 s53, 1
	s_lshl_b32 s53, s53, s49
	s_and_b32 s80, s80, 0xffff0000
	s_or_b32 s80, s53, s80
	s_bitset1_b32 s80, 21
	s_mov_b32 s104, 0x800
	s_mov_b32 s105, 0
	s_mul_i32 s24, s68, 0x100
	s_mul_hi_u32 s47, s24, s14
	s_mul_i32 s24, s24, s14
	s_add_co_u32 s46, s6, s24
	s_add_co_ci_u32 s47, s47, s7
	...
	tensor_load_to_lds s[100:103], s[80:87]
	...
	s_cselect_b64 s[102:103], s[102:103], s[46:47]
	...
	s_add_nc_u64 s[102:103], s[102:103], s[26:27]
...
.Lbranch_000000002b48:
	; --- wave1 A quarter: M[16:31] ---
	s_mov_b32 s95, 0x800
	s_mov_b32 s96, 0x2800
	s_mov_b32 s97, 0x4800
	s_mov_b32 s98, 0x6800
	s_mov_b32 s32, 1
	s_mov_b32 s33, 0
	s_mov_b32 s34, 0
	s_mov_b32 s35, 0x80000000
	...
	s_mul_i32 s24, s24, s13
	s_add_co_u32 s34, s34, s24
	s_add_co_ci_u32 s35, s35, s25
	s_mov_b32 s36, 0
	s_mov_b32 s37, 0
	s_mov_b32 s38, 0
	s_mov_b32 s39, 0
	...
	s_lshr_b32 s26, s27, 16
	s_or_b32 s67, s26, 0x8000000
	; --- wave1 B quarter: N[64:127] ---
	s_mov_b32 s88, 0xc800
	s_mov_b32 s89, 0x14800
	s_mov_b32 s90, 0x1c800
	s_mov_b32 s91, 0x24800
	s_mov_b32 s100, 1
	s_mov_b32 s101, 0
	s_mov_b32 s102, 0
	s_mov_b32 s103, 0x80000000
	...
	s_mul_i32 s24, s24, s14
	s_add_co_u32 s102, s102, s24
	s_add_co_ci_u32 s103, s103, s25
	s_mov_b32 s80, 0
	s_mov_b32 s81, 0
	s_mov_b32 s82, 0
	s_mov_b32 s83, 0
	...
	s_barrier_signal -1
	s_barrier_wait 0xffff
	s_mov_b32 s33, 0x2800
	s_mov_b32 s101, 0x14800
	tensor_load_to_lds s[32:35], s[36:43] th:TH_LOAD_NT
	tensor_load_to_lds s[100:103], s[80:87]
	s_add_co_u32 s24, s58, 0x200
	s_cmp_lt_u32 s24, s70
	...
	s_barrier_signal -1
	s_barrier_wait 0xffff
	s_mov_b32 s33, 0x4800
	s_mov_b32 s101, 0x1c800
	tensor_load_to_lds s[32:35], s[36:43] th:TH_LOAD_NT
	tensor_load_to_lds s[100:103], s[80:87]
	s_add_co_u32 s24, s58, 0x300
	s_cmp_lt_u32 s24, s70
...
.Lbranch_0000000037ac:
	...
	s_lshr_b32 s26, s27, 16
	s_or_b32 s67, s26, 0x8000000
	; --- wave2 B quarter: N[128:191] ---
	s_mov_b32 s88, 0xe800
	s_mov_b32 s89, 0x16800
	s_mov_b32 s90, 0x1e800
	s_mov_b32 s91, 0x26800
	s_mov_b32 s100, 1
	s_mov_b32 s101, 0
	s_mov_b32 s102, 0
	s_mov_b32 s103, 0x80000000
...
.Lbranch_0000000043f8:
	; --- wave3 A quarter: M[48:63] ---
	s_mov_b32 s95, 0x1800
	s_mov_b32 s96, 0x3800
	s_mov_b32 s97, 0x5800
	s_mov_b32 s98, 0x7800
	s_mov_b32 s32, 1
	s_mov_b32 s33, 0
	s_mov_b32 s34, 0
	s_mov_b32 s35, 0x80000000
	...
	s_lshr_b32 s26, s27, 16
	s_or_b32 s67, s26, 0x8000000
	; --- wave3 B quarter: N[192:255] ---
	s_mov_b32 s88, 0x10800
	s_mov_b32 s89, 0x18800
	s_mov_b32 s90, 0x20800
	s_mov_b32 s91, 0x28800
	s_mov_b32 s100, 1
	s_mov_b32 s101, 0
	s_mov_b32 s102, 0
	s_mov_b32 s103, 0x80000000
	...
	s_barrier_wait 0xffff
	s_barrier_wait 0xfffd
	s_mov_b32 s33, 0x1800
	s_mov_b32 s101, 0x10800
	tensor_load_to_lds s[32:35], s[36:43] th:TH_LOAD_NT
	tensor_load_to_lds s[100:103], s[80:87]
	s_add_co_u32 s24, s58, 0x100
	s_cmp_lt_u32 s24, s70
	...
	s_barrier_signal -1
	s_barrier_wait 0xffff
	s_mov_b32 s33, 0x3800
	s_mov_b32 s101, 0x18800
	tensor_load_to_lds s[32:35], s[36:43] th:TH_LOAD_NT
	tensor_load_to_lds s[100:103], s[80:87]
	s_add_co_u32 s24, s58, 0x200
	s_cmp_lt_u32 s24, s70
	...
	s_barrier_signal -1
	s_barrier_wait 0xffff
	s_mov_b32 s33, 0x5800
	s_mov_b32 s101, 0x20800
	tensor_load_to_lds s[32:35], s[36:43] th:TH_LOAD_NT
	tensor_load_to_lds s[100:103], s[80:87]
	s_add_co_u32 s24, s58, 0x300
	s_cmp_lt_u32 s24, s70
