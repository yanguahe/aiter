...
.Lbranch_000000001f08:
	...
	; --- iterate: 4 rows x 0x100 B, 4 iterations along K ---
	s_bitset1_b32 s36, 19
	s_mov_b32 s80, 0
	s_mov_b32 s81, 0x400
	s_mov_b32 s82, 0x100
	s_mov_b32 s83, 0x30000
	s_mov_b32 s84, 0
	s_mov_b32 s85, 0
	s_mov_b32 s86, 0
	s_mov_b32 s87, 0
...
.Lbranch_000000002b48:
	...
	s_or_b32 s40, s40, 4                                      ; preshuffle blocks: 16 * (16 rows * 0x80 bytes)
...
.Lbranch_0000000037ac:
	...
	s_or_b32 s40, s40, 8                                       ; preshuffle blocks: 2 * (32 rows * 0x08 bytes)
	...
	; --- iterate: 8 rows x 0x100 B, 8 iterations along K ---
	s_bitset1_b32 s36, 19
	s_mov_b32 s80, 0
	s_mov_b32 s81, 0x800
	s_mov_b32 s82, 0x100
	s_mov_b32 s83, 0x70000
	s_mov_b32 s84, 0
	s_mov_b32 s85, 0
	s_mov_b32 s86, 0
	s_mov_b32 s87, 0
...
.Lbranch_000000005060:
	...
	s_or_b32 s67, s26, 0x1000000                               ; 0000000050B4: 8C43FF1A 08000000
	...
	s_or_b32 s39, s39, 0x1000000                               ; 000000005248: 8C27FF27 08000000
...
.Lbranch_00000000554c:
	...
	s_or_b32 s67, s26, 0x1000000                               ; 0000000055A0: 8C43FF1A 08000000
	...
	s_or_b32 s39, s39, 0x1000000                               ; 000000005734: 8C27FF27 08000000
