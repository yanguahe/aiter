...
.Lbranch_000000001da0:
	...
	; === Scale descriptor common init (s[80:87], s[88:91]) ===
	s_mov_b32 s80, 0
	s_mov_b32 s81, 0
	s_mov_b32 s82, 0
	s_mov_b32 s83, 0
...
.Lbranch_000000001f08:
	...
	; === wave0 scale descriptor: ScaleA_half1 ===
	; group-1 flags: mask=0xf(multicast), data_size=0, early_timeout=1
	s_mov_b32 s80, 0x00200000
	s_or_b32 s80, s80, 0xf
	; tensor_dim0 = s15 << 5
	s_lshl_b32 s24, s15, 5
	s_lshl_b32 s25, s24, 16
	s_or_b32 s81, s81, s25
	s_lshr_b32 s25, s24, 16
	s_or_b32 s82, s82, s25
	; tensor_dim1 = (M - Mtile*64) / 32
	s_mul_i32 s25, s55, 0x40
	s_sub_co_u32 s25, s17, s25
	s_lshr_b32 s25, s25, 5
	s_lshl_b32 s26, s25, 16
	s_or_b32 s82, s82, s26
	s_lshr_b32 s26, s25, 16
	s_or_b32 s83, s83, s26
	; tile_dim0 = 0x100 (256B)
	s_or_b32 s83, s83, 0x1000000
	; tile_dim1 = 1
	s_or_b32 s84, s84, 1
	; tensor_dim0_stride = s15 << 5
	s_lshl_b32 s25, s15, 5
	s_mov_b32 s85, s25
	; scale global_addr = SA_base + Mtile * stride
	s_mul_i32 s25, s55, 0x40
	s_mul_hi_u32 s91, s25, s15
	s_mul_i32 s25, s25, s15
	s_add_co_u32 s90, s8, s25
	s_add_co_ci_u32 s91, s91, s9
	s_and_b32 s91, s91, 0x1ffffff
	s_or_b32 s91, s91, 0x80000000
	; scale LDS ring
	s_mov_b32 s99, 0x8000
	s_mov_b32 s100, 0x8200
	s_mov_b32 s101, 0x8400
	s_mov_b32 s102, 0x8600
	; --- next-task scale base (s[46:47]) and dim (s93) ---
	s_mul_i32 s25, s69, 0x40
	s_mul_hi_u32 s47, s25, s15
	s_mul_i32 s25, s25, s15
	s_add_co_u32 s46, s8, s25
	s_add_co_ci_u32 s47, s47, s9
	s_and_b32 s47, s47, 0x1ffffff
	s_or_b32 s47, s47, 0x80000000
	s_mul_i32 s27, s69, 0x40
	s_sub_co_u32 s27, s17, s27
	s_lshr_b32 s27, s27, 5
	s_lshl_b32 s26, s27, 16
	s_and_b32 s93, s82, 0xffff
	s_or_b32 s93, s93, s26
	; --- scale byte step constant ---
	s_mov_b32 s104, 0x100
	s_mov_b32 s105, 0
	...
	s_mov_b32 s89, s99
	tensor_load_to_lds s[88:91], s[80:87]
	...
	s_cselect_b64 s[90:91], s[90:91], s[46:47]
	s_cselect_b32 s82, s82, s93
	...
	s_cselect_b64 s[26:27], s[104:105], 0
...
.Lbranch_000000002b48:
	...
	; === wave1 scale descriptor: ScaleA_half2 ===
	s_mov_b32 s80, 0x00200000
	s_or_b32 s80, s80, 0xf
	s_lshl_b32 s24, s15, 5
	s_lshl_b32 s25, s24, 16
	...
	s_lshl_b32 s25, s15, 5
	s_mov_b32 s85, s25
	; global_addr = SA_base + (Mtile*0x40 + 0x20) * stride (second M32)
	s_mul_i32 s25, s55, 0x40
	...
	s_and_b32 s91, s91, 0x1ffffff
	s_or_b32 s91, s91, 0x80000000
	s_mov_b32 s99, 0x8100
	s_mov_b32 s100, 0x8300
	s_mov_b32 s101, 0x8500
	s_mov_b32 s102, 0x8700
	; --- next-task scale base (s[46:47]) and dim (s93) ---
	s_mul_i32 s25, s69, 0x40
	s_add_co_i32 s25, s25, 0x20
	s_mul_hi_u32 s47, s25, s15
...
.Lbranch_0000000037ac:
	...
	; === wave2 scale descriptor: ScaleB_half1 ===
	s_mov_b32 s80, 0x00200000
	s_mov_b32 s24, 1
	s_lshl_b32 s24, s24, s49
	s_or_b32 s80, s80, s24
	...
	s_mov_b32 s85, s25
	; global_addr = SB_base + Ntile*0x100 * stride
	s_mul_i32 s25, s54, 0x100
	s_mul_hi_u32 s91, s25, s16
	s_mul_i32 s25, s25, s16
	s_add_co_u32 s90, s10, s25
	s_add_co_ci_u32 s91, s91, s11
	s_and_b32 s91, s91, 0x1ffffff
	s_or_b32 s91, s91, 0x80000000
	s_mov_b32 s99, 0x8800
	s_mov_b32 s100, 0x9000
	s_mov_b32 s101, 0x9800
	s_mov_b32 s102, 0xa000
	; --- next-task scale base (s[46:47]) and dim (s93) ---
	s_mul_i32 s25, s68, 0x100
	s_mul_hi_u32 s47, s25, s16
	s_mul_i32 s25, s25, s16
	s_add_co_u32 s46, s10, s25
	s_add_co_ci_u32 s47, s47, s11
	s_and_b32 s47, s47, 0x1ffffff
	s_or_b32 s47, s47, 0x80000000
	s_mul_i32 s27, s68, 0x100
	s_sub_co_u32 s27, s18, s27
	s_lshr_b32 s27, s27, 5
	s_lshl_b32 s26, s27, 16
	s_and_b32 s93, s82, 0xffff
	s_or_b32 s93, s93, s26
...
.Lbranch_0000000043f8:
	...
	; === wave3 scale descriptor: ScaleB_half2 ===
	s_mov_b32 s80, 0x00200000
	s_mov_b32 s24, 1
	s_lshl_b32 s24, s24, s49
	s_or_b32 s80, s80, s24
	...
	s_lshl_b32 s25, s16, 5
	s_mov_b32 s85, s25
	; global_addr = SB_base + (Ntile*0x100 + 0x80) * stride (second N128)
	s_mul_i32 s25, s54, 0x100
	...
	s_and_b32 s91, s91, 0x1ffffff
	s_or_b32 s91, s91, 0x80000000
	s_mov_b32 s99, 0x8c00
	s_mov_b32 s100, 0x9400
	s_mov_b32 s101, 0x9c00
	s_mov_b32 s102, 0xa400
	; --- next-task scale base (s[46:47]) and dim (s93) ---
	s_mul_i32 s25, s68, 0x100
	s_add_co_i32 s25, s25, 0x80
	s_mul_hi_u32 s47, s25, s16
