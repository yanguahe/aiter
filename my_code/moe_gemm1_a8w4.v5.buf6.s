	...
	.text
	.globl	gemm_a8w4_tdm_t64x256x256_w1x4_b6_e384_afp8_outbf16_silu_bias1_qout0_qrep1_v1
	.p2align	8
	.type	gemm_a8w4_tdm_t64x256x256_w1x4_b6_e384_afp8_outbf16_silu_bias1_qout0_qrep1_v1,@function
gemm_a8w4_tdm_t64x256x256_w1x4_b6_e384_afp8_outbf16_silu_bias1_qout0_qrep1_v1:
	...
	v_add_nc_u32_e32 v104, 0x40800, v6
	v_add_nc_u32_e32 v105, 0x41000, v6
	v_add_nc_u32_e32 v106, 0x41800, v6
	v_add_nc_u32_e32 v107, 0x42000, v6
	v_add_nc_u32_e32 v108, 0x42800, v6
	v_add_nc_u32_e32 v109, 0x43000, v6
	v_add_nc_u32_e32 v110, 0x43800, v6
	v_add_nc_u32_e32 v111, 0x44000, v6
	v_add_nc_u32_e32 v112, 0x44800, v6
	v_add_nc_u32_e32 v113, 0x45000, v6
	v_add_nc_u32_e32 v114, 0x45800, v6
	v_add_nc_u32_e32 v115, 0x46000, v6
	v_add_nc_u32_e32 v116, 0x46800, v6
	v_add_nc_u32_e32 v117, 0x47000, v6
	v_add_nc_u32_e32 v118, 0x47800, v6
	v_add_nc_u32_e32 v119, 0x48000, v6
	v_add_nc_u32_e32 v120, 0x48800, v6
	v_add_nc_u32_e32 v121, 0x49000, v6
	v_add_nc_u32_e32 v122, 0x49800, v6
	v_add_nc_u32_e32 v123, 0x4a000, v6
	v_add_nc_u32_e32 v124, 0x4a800, v6
	v_add_nc_u32_e32 v125, 0x4b000, v6
	v_add_nc_u32_e32 v126, 0x4b800, v6
	v_add_nc_u32_e32 v127, 0x4c000, v6
	v_add_nc_u32_e32 v128, 0x4c800, v6
	v_add_nc_u32_e32 v129, 0x4d000, v6
...
.LBB0_49:
	s_add_nc_u64 s[18:19], s[12:13], 0x400
	s_mov_b32 s14, 0
	s_add_co_i32 s17, 0, 0x40200
...
.LBB0_54:
	...
	s_add_nc_u64 s[8:9], s[8:9], 0x38500
	s_add_co_i32 s81, s61, 0x2200
	s_add_co_i32 s82, s14, 0x38500
...
.LBB0_55:
	...
	s_add_nc_u64 s[14:15], s[8:9], 0x2800
	s_add_co_i32 s14, s61, 0x4400
	s_bitset1_b32 s15, 31
	s_wait_alu depctr_vm_vsrc(0)
	v_dual_mov_b32 v65, s14 :: v_dual_add_nc_u32 v66, 0x2800, v64
...
.LBB0_57:
	...
	s_add_nc_u64 s[8:9], s[8:9], 0x72800
	s_add_co_i32 s8, s61, 0x8400
	s_bitset1_b32 s9, 31
	s_wait_alu depctr_vm_vsrc(0)
	v_dual_mov_b32 v65, s8 :: v_dual_add_nc_u32 v64, 0x72800, v64
...
.LBB0_61:
	...
	s_add_nc_u64 s[8:9], s[8:9], 0x1ca0
	s_add_co_i32 s62, s10, 0x1ca0
...
.LBB0_62:
	...
	s_lshl2_add_u32 s10, s80, 0
	s_add_nc_u64 s[8:9], s[22:23], 0x500
	s_add_co_i32 s10, s10, 0xc600
	s_or_b32 s8, s9, 0x80000000
	s_wait_alu depctr_vm_vsrc(0)
	v_dual_mov_b32 v65, s10 :: v_dual_add_nc_u32 v66, 0x500, v64
...
.LBB0_64:
	...
	s_lshl2_add_u32 s10, s80, 0
	s_add_nc_u64 s[8:9], s[22:23], 0x7500
	s_add_co_i32 s10, s10, 0xca00
	s_or_b32 s8, s9, 0x80000000
	s_wait_alu depctr_vm_vsrc(0)
	v_dual_mov_b32 v65, s10 :: v_dual_add_nc_u32 v64, 0x7500, v64
	v_mov_b32_e32 v67, s8
	s_set_vgpr_msb 1
	v_readfirstlane_b32 s80, v64 /*v320*/
	s_mov_b32 s8, s44
...
.LBB0_66:
	s_add_nc_u64 s[8:9], s[64:65], s[56:57]
	s_add_co_i32 s14, s79, s56
	s_add_nc_u64 s[8:9], s[8:9], 0x500
	s_add_co_i32 s62, s14, 0x500
	s_or_b32 s63, s9, 0x80000000
	s_delay_alu instid0(SALU_CYCLE_1)
...
.LBB0_67:
	...
	s_add_co_i32 s10, s78, s52
	s_add_nc_u64 s[8:9], s[8:9], 0xa0
	s_add_co_i32 s62, s10, 0xa0
	s_or_b32 s63, s9, 0x80000000
	s_mov_b32 s45, s17
	s_mov_b32 s46, s18
	s_mov_b32 s48, s20
...
.LBB0_68:
	...
	v_add_nc_u32_e32 v0, 0xfffbfa00, v64 /*v320*/
	v_add_nc_u32_e32 v1, 0xfffbfc00, v64 /*v320*/
	s_wait_tensorcnt 0x6
	s_barrier_signal -1
	s_barrier_wait -1
	v_add_nc_u32_e32 v2, 0xfffc0200, v64 /*v320*/
	s_wait_alu depctr_va_vdst(0)
	s_set_vgpr_msb 0x440
	...
	s_wait_alu depctr_vm_vsrc(1)
	s_set_vgpr_msb 0x4004
	v_add_nc_u32_e32 v0, 0xfffc0a00, v64 /*v320*/
	s_wait_alu depctr_vm_vsrc(0)
	v_add_nc_u32_e32 v1, 0xfffc0c00, v64 /*v320*/
	v_add_nc_u32_e32 v3, 0xfffc0400, v64 /*v320*/
	s_set_vgpr_msb 0x440
	ds_load_b128 v[56:59] /*v[312:315]*/, v2
	s_wait_alu depctr_vm_vsrc(0)
	s_set_vgpr_msb 0x4004
	v_add_nc_u32_e32 v2, 0xfffc1200, v64 /*v320*/
	s_wait_alu depctr_va_vdst(3)
	s_set_vgpr_msb 0x440
	ds_load_b128 v[0:3] /*v[256:259]*/, v0
	s_wait_alu depctr_vm_vsrc(0)
	s_set_vgpr_msb 0x4004
	v_add_nc_u32_e32 v0, 0xfffbfa00, v83 /*v339*/
	s_wait_alu depctr_va_vdst(3)
	s_set_vgpr_msb 0x440
	ds_load_b128 v[4:7] /*v[260:263]*/, v1
	s_wait_alu depctr_vm_vsrc(0)
	s_set_vgpr_msb 0x4004
	v_add_nc_u32_e32 v1, 0xfffbfa40, v83 /*v339*/
	v_add_nc_u32_e32 v64, 0xfffbfe00, v64 /*v320*/
	s_wait_alu depctr_va_vdst(4)
	s_set_vgpr_msb 0x440
	ds_load_b128 v[60:63] /*v[316:319]*/, v3
	s_wait_alu depctr_vm_vsrc(0)
	s_set_vgpr_msb 0x4004
	v_add_nc_u32_e32 v3, 0xfffc1400, v64 /*v320*/
	s_wait_alu depctr_va_vdst(4)
	s_set_vgpr_msb 0x440
	...
	ds_load_b32 v136, v0
	s_wait_alu depctr_vm_vsrc(0)
	v_add_nc_u32_e32 v0, 0xfffbfb00, v83 /*v339*/
	v_add_nc_u32_e32 v2, 0xfffbfa40, v86 /*v342*/
	s_wait_alu depctr_va_vdst(4)
	ds_load_b32 v137, v1
	s_wait_alu depctr_vm_vsrc(0)
	v_add_nc_u32_e32 v1, 0xfffcbe04, v84 /*v340*/
	v_add_nc_u32_e32 v65, 0xfffc0000, v64 /*v320*/
	s_wait_alu depctr_va_vdst(5)
	s_set_vgpr_msb 0x440
	ds_load_b128 v[16:19] /*v[272:275]*/, v64
	s_wait_alu depctr_vm_vsrc(0)
	s_set_vgpr_msb 0x4004
	v_add_nc_u32_e32 v64, 0xfffc0600, v64 /*v320*/
	s_wait_alu depctr_va_vdst(5)
	s_set_vgpr_msb 0x440
	ds_load_b128 v[12:15] /*v[268:271]*/, v3
	s_wait_alu depctr_vm_vsrc(0)
	s_set_vgpr_msb 0x4004
	v_add_nc_u32_e32 v3, 0xfffcbe00, v84 /*v340*/
	s_wait_alu depctr_va_vdst(5)
	ds_load_b32 v138, v0
	s_wait_alu depctr_va_vdst(4)
	ds_load_b32 v139, v2
	s_wait_alu depctr_vm_vsrc(1)
	v_add_nc_u32_e32 v0, 0xfffcbe08, v84 /*v340*/
	s_wait_alu depctr_va_vdst(4)
	ds_load_b32 v141, v1
	s_wait_alu depctr_vm_vsrc(0)
	v_add_nc_u32_e32 v1, 0xfffcbe0c, v84 /*v340*/
	v_add_nc_u32_e32 v2, 0xfffbfa00, v85 /*v341*/
	v_add_nc_u32_e32 v4, 0xfffbfa20, v85 /*v341*/
	v_add_nc_u32_e32 v8, 0xfffbfa40, v85 /*v341*/
	v_add_nc_u32_e32 v12, 0xfffbfa60, v85 /*v341*/
	v_add_nc_u32_e32 v16, 0xfffc0b00, v85 /*v341*/
	v_add_nc_u32_e32 v20, 0xfffc0b20, v85 /*v341*/
	v_add_nc_u32_e32 v24, 0xfffc0b40, v85 /*v341*/
	v_add_nc_u32_e32 v28, 0xfffc0b60, v85 /*v341*/
	v_add_nc_u32_e32 v32, 0xfffc1c00, v85 /*v341*/
	v_add_nc_u32_e32 v36, 0xfffc1c20, v85 /*v341*/
	v_add_nc_u32_e32 v40, 0xfffc1c40, v85 /*v341*/
	v_add_nc_u32_e32 v44, 0xfffc1c60, v85 /*v341*/
	v_add_nc_u32_e32 v48, 0xfffc2d00, v85 /*v341*/
	v_add_nc_u32_e32 v52, 0xfffc2d20, v85 /*v341*/
	v_add_nc_u32_e32 v56, 0xfffc2d40, v85 /*v341*/
	v_add_nc_u32_e32 v60, 0xfffc2d60, v85 /*v341*/
	s_wait_alu depctr_va_vdst(14)
	s_set_vgpr_msb 0x440
	ds_load_b128 v[20:23] /*v[276:279]*/, v65
	s_wait_alu depctr_vm_vsrc(0)
	s_set_vgpr_msb 0x4004
	v_add_nc_u32_e32 v65, 0xfffc0800, v64 /*v320*/
	s_set_vgpr_msb 0x440
	ds_load_b128 v[24:27] /*v[280:283]*/, v64
	s_wait_alu depctr_vm_vsrc(0)
	s_set_vgpr_msb 0x4004
	v_add_nc_u32_e32 v64, 0xfffc1600, v64 /*v320*/
	ds_load_b32 v140, v3
	ds_load_b32 v142, v0
	ds_load_b32 v143, v1
	s_wait_alu depctr_vm_vsrc(0)
	...
	v_add_nc_u32_e32 v66, 0xfffc0e00, v64 /*v320*/
	v_add_nc_u32_e32 v67, 0xfffc1000, v64 /*v320*/
	s_wait_alu depctr_va_vdst(3)
	s_set_vgpr_msb 0x440
	ds_load_b128 v[28:31] /*v[284:287]*/, v65
	s_wait_alu depctr_vm_vsrc(0)
	s_set_vgpr_msb 0x4004
	v_add_nc_u32_e32 v65, 0xfffc1800, v64 /*v320*/
	s_wait_alu depctr_va_vdst(3)
	s_set_vgpr_msb 0x440
	ds_load_b128 v[40:43] /*v[296:299]*/, v64
	s_wait_alu depctr_vm_vsrc(0)
	s_set_vgpr_msb 0x4004
	v_add_nc_u32_e32 v64, 0xfffbfa80, v83 /*v339*/
	s_wait_alu depctr_va_vdst(3)
	s_set_vgpr_msb 0x440
	...
	s_wait_alu depctr_vm_vsrc(1)
	s_set_vgpr_msb 0x4004
	v_add_nc_u32_e32 v66, 0xfffbfac0, v83 /*v339*/
	s_wait_alu depctr_vm_vsrc(0)
	v_add_nc_u32_e32 v67, 0xfffbfb80, v83 /*v339*/
	s_wait_alu depctr_va_vdst(3)
	s_set_vgpr_msb 0x440
	ds_load_b128 v[44:47] /*v[300:303]*/, v65
	s_wait_alu depctr_vm_vsrc(0)
	s_set_vgpr_msb 0x4004
	v_add_nc_u32_e32 v65, 0xfffbfbc0, v83 /*v339*/
	s_wait_alu depctr_va_vdst(3)
	ds_load_b32 v144, v64
	s_wait_alu depctr_vm_vsrc(0)
	v_add_nc_u32_e32 v64, 0xfffcbe10, v84 /*v340*/
	s_wait_alu depctr_va_vdst(3)
	...
	s_wait_alu depctr_vm_vsrc(0)
	v_add_nc_u32_e32 v65, 0xfffcbe14, v84 /*v340*/
	v_add_nc_u32_e32 v66, 0xfffcbe18, v84 /*v340*/
	v_add_nc_u32_e32 v67, 0xfffcbe1c, v84 /*v340*/
	s_wait_alu depctr_va_vdst(3)
	ds_load_b32 v148, v64
	s_wait_alu depctr_vm_vsrc(0)
	v_add_nc_u32_e32 v64, 0xfffbfa80, v85 /*v341*/
	v_add_nc_u32_e32 v68, 0xfffbfaa0, v85 /*v341*/
	v_add_nc_u32_e32 v72, 0xfffbfac0, v85 /*v341*/
	v_add_nc_u32_e32 v76, 0xfffbfae0, v85 /*v341*/
	v_add_nc_u32_e32 v80, 0xfffc0b80, v85 /*v341*/
	v_add_nc_u32_e32 v84, 0xfffc0ba0, v85 /*v341*/
	v_add_nc_u32_e32 v88, 0xfffc0bc0, v85 /*v341*/
	v_add_nc_u32_e32 v92, 0xfffc0be0, v85 /*v341*/
	v_add_nc_u32_e32 v96, 0xfffc1c80, v85 /*v341*/
	v_add_nc_u32_e32 v100, 0xfffc1ca0, v85 /*v341*/
	v_add_nc_u32_e32 v104, 0xfffc1cc0, v85 /*v341*/
	v_add_nc_u32_e32 v108, 0xfffc1ce0, v85 /*v341*/
	v_add_nc_u32_e32 v112, 0xfffc2d80, v85 /*v341*/
	v_add_nc_u32_e32 v116, 0xfffc2da0, v85 /*v341*/
	v_add_nc_u32_e32 v120, 0xfffc2dc0, v85 /*v341*/
	v_add_nc_u32_e32 v124, 0xfffc2de0, v85 /*v341*/
	s_wait_alu depctr_va_vdst(14)
...
.LBB0_93:
	s_add_nc_u64 s[10:11], s[12:13], 0x300
	s_mov_b32 s86, 0
	s_add_co_i32 s9, 0, 0x33400
	s_bitset1_b32 s11, 31
	s_movk_i32 s85, 0x700
	s_mov_b32 s84, 4
	s_mov_b32 s83, 0x407fff
...
.LBB0_94:
	s_max_i32 s14, s33, 0
	s_add_nc_u64 s[10:11], s[64:65], 0x400
	s_mov_b32 s86, 0
	s_lshl_b32 s15, s14, 16
	s_lshr_b32 s14, s14, 16
	s_bitset1_b32 s11, 31
	s_add_co_i32 s9, 0, 0x33800
	s_or_b32 s82, s15, 0x7fff
	s_or_b32 s83, s14, 0x1000000
	s_movk_i32 s85, 0x1c00
	s_mov_b32 s84, 32
...
.LBB0_95:
	s_max_i32 s14, s40, 0
	s_add_nc_u64 s[10:11], s[20:21], 0x400
	s_mov_b32 s86, 0
	s_lshl_b32 s15, s14, 16
	s_lshr_b32 s14, s14, 16
	s_bitset1_b32 s11, 31
	s_add_co_i32 s9, 0, 0x35a00
	s_or_b32 s82, s15, 0x7fff
	s_or_b32 s83, s14, 0x1000000
	s_movk_i32 s85, 0x1c00
	s_mov_b32 s84, 32
...
.LBB0_96:
	s_add_nc_u64 s[10:11], s[24:25], 0x2000
	s_mov_b32 s80, 0
	s_add_co_i32 s9, 0, 0x37c00
	s_bitset1_b32 s11, 31
	s_mov_b32 s85, 0xe000
	s_mov_b32 s84, 8
	s_mov_b32 s83, 0x8007fff
...
.LBB0_97:
	s_add_nc_u64 s[10:11], s[26:27], 0x2000
	s_mov_b32 s80, 0
	s_add_co_i32 s9, 0, 0x3bc00
	s_bitset1_b32 s11, 31
	s_mov_b32 s85, 0xe000
	s_mov_b32 s84, 8
	s_mov_b32 s83, 0x8007fff
...
.LBB0_98:
	s_add_nc_u64 s[10:11], s[28:29], 0x80
	s_mov_b32 s86, 0
	s_add_co_i32 s9, 0, 0x3fc00
	s_bitset1_b32 s11, 31
	s_movk_i32 s85, 0xe0
	s_mov_b32 s84, 8
	s_mov_b32 s83, 0x87fff
...
.LBB0_99:
	s_add_nc_u64 s[10:11], s[36:37], 0x80
	s_mov_b32 s86, 0
	s_add_co_i32 s9, 0, 0x3fd00
	s_bitset1_b32 s11, 31
	s_movk_i32 s85, 0xe0
	s_mov_b32 s84, 8
	s_mov_b32 s83, 0x87fff
...
.LBB0_100:
	s_add_nc_u64 s[10:11], s[38:39], 0x400
	s_mov_b32 s86, 0
	s_add_co_i32 s9, 0, 0x3fe00
	s_bitset1_b32 s11, 31
	s_movk_i32 s85, 0x700
	s_mov_b32 s84, 4
	s_mov_b32 s83, 0x407fff
	...
	.p2align	6, 0x0
	.amdhsa_kernel gemm_a8w4_tdm_t64x256x256_w1x4_b6_e384_afp8_outbf16_silu_bias1_qout0_qrep1_v1
	...
	.text
.Lfunc_end0:
	.size	gemm_a8w4_tdm_t64x256x256_w1x4_b6_e384_afp8_outbf16_silu_bias1_qout0_qrep1_v1, .Lfunc_end0-gemm_a8w4_tdm_t64x256x256_w1x4_b6_e384_afp8_outbf16_silu_bias1_qout0_qrep1_v1

	.set gemm_a8w4_tdm_t64x256x256_w1x4_b6_e384_afp8_outbf16_silu_bias1_qout0_qrep1_v1.num_vgpr, 346
	.set gemm_a8w4_tdm_t64x256x256_w1x4_b6_e384_afp8_outbf16_silu_bias1_qout0_qrep1_v1.num_agpr, 0
	.set gemm_a8w4_tdm_t64x256x256_w1x4_b6_e384_afp8_outbf16_silu_bias1_qout0_qrep1_v1.numbered_sgpr, 88
	.set gemm_a8w4_tdm_t64x256x256_w1x4_b6_e384_afp8_outbf16_silu_bias1_qout0_qrep1_v1.num_named_barrier, 0
	.set gemm_a8w4_tdm_t64x256x256_w1x4_b6_e384_afp8_outbf16_silu_bias1_qout0_qrep1_v1.private_seg_size, 0
	.set gemm_a8w4_tdm_t64x256x256_w1x4_b6_e384_afp8_outbf16_silu_bias1_qout0_qrep1_v1.uses_vcc, 1
	.set gemm_a8w4_tdm_t64x256x256_w1x4_b6_e384_afp8_outbf16_silu_bias1_qout0_qrep1_v1.uses_flat_scratch, 0
	.set gemm_a8w4_tdm_t64x256x256_w1x4_b6_e384_afp8_outbf16_silu_bias1_qout0_qrep1_v1.has_dyn_sized_stack, 0
	.set gemm_a8w4_tdm_t64x256x256_w1x4_b6_e384_afp8_outbf16_silu_bias1_qout0_qrep1_v1.has_recursion, 0
	.set gemm_a8w4_tdm_t64x256x256_w1x4_b6_e384_afp8_outbf16_silu_bias1_qout0_qrep1_v1.has_indirect_call, 0
...
amdhsa.kernels:
  - .args:
    ...
    .name:           gemm_a8w4_tdm_t64x256x256_w1x4_b6_e384_afp8_outbf16_silu_bias1_qout0_qrep1_v1
    ...
    .sgpr_count:     90
    .sgpr_spill_count: 0
    .symbol:         gemm_a8w4_tdm_t64x256x256_w1x4_b6_e384_afp8_outbf16_silu_bias1_qout0_qrep1_v1.kd
