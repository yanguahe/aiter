	...
	.text
	.globl	a8w4_tdm_fp4_t64x256x256_w1x4_b2_K7168_e96_act1_wpt4_directscale_v1
	.p2align	8
	.type	a8w4_tdm_fp4_t64x256x256_w1x4_b2_K7168_e96_act1_wpt4_directscale_v1,@function
a8w4_tdm_fp4_t64x256x256_w1x4_b2_K7168_e96_act1_wpt4_directscale_v1:
...
.LBB0_3:
	...
	; ScaleA raw v[240:243] -> v232/v233/v236/v237.
	v_permlane_xor_b32 v232, v241, 8, 16
	v_permlane_xor_b32 v233, v240, 8, 16
	v_permlane_xor_b32 v236, v243, 8, 16
	v_permlane_xor_b32 v237, v242, 8, 16
	s_wait_alu depctr_va_vdst(0)
	v_cndmask_b32_e64 v232, v240, v232, s70
	v_cndmask_b32_e64 v233, v233, v241, s70
	v_cndmask_b32_e64 v236, v242, v236, s70
	v_cndmask_b32_e64 v237, v237, v243, s70
	; ScaleB raw v[244:247] -> v230/v231/v234/v235.
	v_permlane_xor_b32 v230, v245, 8, 16
	v_permlane_xor_b32 v231, v244, 8, 16
	v_permlane_xor_b32 v234, v247, 8, 16
	v_permlane_xor_b32 v235, v246, 8, 16
	s_wait_alu depctr_va_vdst(0)
	v_cndmask_b32_e64 v230, v244, v230, s70
	v_cndmask_b32_e64 v231, v231, v245, s70
	v_cndmask_b32_e64 v234, v246, v234, s70
	v_cndmask_b32_e64 v235, v235, v247, s70
	s_wait_alu depctr_va_vdst(0)
	v_permlane16_swap_b32 v232, v236
	v_permlane16_swap_b32 v233, v237
	v_permlane16_swap_b32 v230, v234
	v_permlane16_swap_b32 v231, v235
	s_wait_alu depctr_va_vdst(0)
	; Butterfly lanes are j*8+chunk; WMMA needs chunk*4+j.
	ds_bpermute_b32 v240, v239, v230
	ds_bpermute_b32 v241, v239, v231
	ds_bpermute_b32 v242, v239, v232
	ds_bpermute_b32 v243, v239, v233
	ds_bpermute_b32 v244, v239, v234
	ds_bpermute_b32 v245, v239, v235
	ds_bpermute_b32 v246, v239, v236
	ds_bpermute_b32 v247, v239, v237
	s_wait_dscnt 0x0
	v_dual_mov_b32 v230, v240 :: v_dual_mov_b32 v231, v241
	v_dual_mov_b32 v232, v242 :: v_dual_mov_b32 v233, v243
	v_dual_mov_b32 v234, v244 :: v_dual_mov_b32 v235, v245
...
.Lmoe_v1_scale_slot1:
	; ScaleA raw v[248:251] -> v232/v233/v236/v237.
	v_permlane_xor_b32 v232, v249, 8, 16
	v_permlane_xor_b32 v233, v248, 8, 16
	v_permlane_xor_b32 v236, v251, 8, 16
	v_permlane_xor_b32 v237, v250, 8, 16
	s_wait_alu depctr_va_vdst(0)
	v_cndmask_b32_e64 v232, v248, v232, s70
	v_cndmask_b32_e64 v233, v233, v249, s70
	v_cndmask_b32_e64 v236, v250, v236, s70
	v_cndmask_b32_e64 v237, v237, v251, s70
	; ScaleB raw v[252:255] -> v230/v231/v234/v235.
	v_permlane_xor_b32 v230, v253, 8, 16
	v_permlane_xor_b32 v231, v252, 8, 16
	v_permlane_xor_b32 v234, v255, 8, 16
	v_permlane_xor_b32 v235, v254, 8, 16
	s_wait_alu depctr_va_vdst(0)
	v_cndmask_b32_e64 v230, v252, v230, s70
	v_cndmask_b32_e64 v231, v231, v253, s70
	v_cndmask_b32_e64 v234, v254, v234, s70
	v_cndmask_b32_e64 v235, v235, v255, s70
	s_wait_alu depctr_va_vdst(0)
	v_permlane16_swap_b32 v232, v236
	v_permlane16_swap_b32 v233, v237
	v_permlane16_swap_b32 v230, v234
	...
	s_wait_alu depctr_va_vdst(0)
	; Butterfly lanes are j*8+chunk; WMMA needs chunk*4+j.
	ds_bpermute_b32 v248, v239, v230
	ds_bpermute_b32 v249, v239, v231
	ds_bpermute_b32 v250, v239, v232
	ds_bpermute_b32 v251, v239, v233
	ds_bpermute_b32 v252, v239, v234
	ds_bpermute_b32 v253, v239, v235
	ds_bpermute_b32 v254, v239, v236
	ds_bpermute_b32 v255, v239, v237
	s_wait_dscnt 0x0
	v_dual_mov_b32 v230, v248 :: v_dual_mov_b32 v231, v249
	v_dual_mov_b32 v232, v250 :: v_dual_mov_b32 v233, v251
	v_dual_mov_b32 v234, v252 :: v_dual_mov_b32 v235, v253
	v_dual_mov_b32 v236, v254 :: v_dual_mov_b32 v237, v255
	s_wait_alu depctr_va_vdst(0)
...
.LBB0_4:
	...
	v_wmma_scale_f32_32x16x128_f4 v[0:15], v[144:159], v[196:203], v[0:15], v234, v233 matrix_b_scale:MATRIX_SCALE_ROW1
	ds_load_b128 v[144:147], v194 offset:51520
	ds_load_b128 v[148:151], v194 offset:51552
	v_wmma_scale_f32_32x16x128_f4 v[16:31], v[128:143], v[196:203], v[16:31], v230, v233 matrix_b_scale:MATRIX_SCALE_ROW1
	s_wait_dscnt 0x4
	v_wmma_scale_f32_32x16x128_f4 v[112:127], v[160:175], v[204:211], v[112:127], v231, v236
	s_wait_dscnt 0x2
	v_wmma_scale_f32_32x16x128_f4 v[96:111], v[176:191], v[204:211], v[96:111], v235, v236
	v_wmma_scale_f32_32x16x128_f4 v[64:79], v[176:191], v[212:219], v[64:79], v235, v236 matrix_b_scale:MATRIX_SCALE_ROW1
	v_wmma_scale_f32_32x16x128_f4 v[80:95], v[160:175], v[212:219], v[80:95], v231, v236 matrix_b_scale:MATRIX_SCALE_ROW1
	v_wmma_scale_f32_32x16x128_f4 v[48:63], v[160:175], v[220:227], v[48:63], v231, v237
	v_wmma_scale_f32_32x16x128_f4 v[32:47], v[176:191], v[220:227], v[32:47], v235, v237
	s_wait_dscnt 0x0
	v_wmma_scale_f32_32x16x128_f4 v[0:15], v[176:191], v[144:151], v[0:15], v235, v237 matrix_b_scale:MATRIX_SCALE_ROW1
	v_wmma_scale_f32_32x16x128_f4 v[16:31], v[160:175], v[144:151], v[16:31], v231, v237 matrix_b_scale:MATRIX_SCALE_ROW1
...
.LBB0_5:
	...
	.p2align	6, 0x0
	.amdhsa_kernel a8w4_tdm_fp4_t64x256x256_w1x4_b2_K7168_e96_act1_wpt4_directscale_v1
	...
	.text
.Lfunc_end0:
	.size	a8w4_tdm_fp4_t64x256x256_w1x4_b2_K7168_e96_act1_wpt4_directscale_v1, .Lfunc_end0-a8w4_tdm_fp4_t64x256x256_w1x4_b2_K7168_e96_act1_wpt4_directscale_v1

	.set a8w4_tdm_fp4_t64x256x256_w1x4_b2_K7168_e96_act1_wpt4_directscale_v1.num_vgpr, 256
	.set a8w4_tdm_fp4_t64x256x256_w1x4_b2_K7168_e96_act1_wpt4_directscale_v1.num_agpr, 0
	.set a8w4_tdm_fp4_t64x256x256_w1x4_b2_K7168_e96_act1_wpt4_directscale_v1.numbered_sgpr, 88
	.set a8w4_tdm_fp4_t64x256x256_w1x4_b2_K7168_e96_act1_wpt4_directscale_v1.num_named_barrier, 0
	.set a8w4_tdm_fp4_t64x256x256_w1x4_b2_K7168_e96_act1_wpt4_directscale_v1.private_seg_size, 0
	.set a8w4_tdm_fp4_t64x256x256_w1x4_b2_K7168_e96_act1_wpt4_directscale_v1.uses_vcc, 0
	.set a8w4_tdm_fp4_t64x256x256_w1x4_b2_K7168_e96_act1_wpt4_directscale_v1.uses_flat_scratch, 0
	.set a8w4_tdm_fp4_t64x256x256_w1x4_b2_K7168_e96_act1_wpt4_directscale_v1.has_dyn_sized_stack, 0
	.set a8w4_tdm_fp4_t64x256x256_w1x4_b2_K7168_e96_act1_wpt4_directscale_v1.has_recursion, 0
	.set a8w4_tdm_fp4_t64x256x256_w1x4_b2_K7168_e96_act1_wpt4_directscale_v1.has_indirect_call, 0
...
amdhsa.kernels:
  - .args:
    ...
    .name:           a8w4_tdm_fp4_t64x256x256_w1x4_b2_K7168_e96_act1_wpt4_directscale_v1
    ...
    .sgpr_count:     88
    .sgpr_spill_count: 0
    .symbol:         a8w4_tdm_fp4_t64x256x256_w1x4_b2_K7168_e96_act1_wpt4_directscale_v1.kd
