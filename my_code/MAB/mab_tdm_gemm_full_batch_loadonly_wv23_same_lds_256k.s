...
// Keeps the TDM control/synchronization plan; aliases WV2/WV3 B producer LDS.
// removes LDS consumers, WMMA, C/D access, conversion, and stores.

.amdgcn_target "amdgcn-amd-amdhsa--gfx1250"

.text
.globl mab_tdm_gemm_full_batch_loadonly_wv23_same_lds_256k
.protected mab_tdm_gemm_full_batch_loadonly_wv23_same_lds_256k
.type mab_tdm_gemm_full_batch_loadonly_wv23_same_lds_256k,@function
.p2align 8
...
.Lloadonly_0404:
	...
	s_mov_b32 s95, 0                                           // B producer alias: wave3 uses wave2 LDS copy
...
.Lfunc_end0:
.size mab_tdm_gemm_full_batch_loadonly_wv23_same_lds_256k, .Lfunc_end0-mab_tdm_gemm_full_batch_loadonly_wv23_same_lds_256k
...
.p2align 6
.amdhsa_kernel mab_tdm_gemm_full_batch_loadonly_wv23_same_lds_256k
...
amdhsa.kernels:
  - .args:
    ...
    .name:           mab_tdm_gemm_full_batch_loadonly_wv23_same_lds_256k
    .private_segment_fixed_size: 0
    .sgpr_count:     97
    .symbol:         mab_tdm_gemm_full_batch_loadonly_wv23_same_lds_256k.kd
